"""Data-quality validation for the processed SLA dataset.

Checks the processed SLA .npz file for:
  - existence
...
def validate() -> bool:
    ...
    if not os.path.exists(PROCESSED_NPZ):
        ...
        print("       Run 'python src/data/preprocess_sla_5g.py' first.")
        return False
    ...
    print("[PASS] All SLA data validation checks passed.")
