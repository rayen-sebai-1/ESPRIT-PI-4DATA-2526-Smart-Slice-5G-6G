"""Redis helpers for Policy Control."""
...
from .config import PolicyControlConfig, get_config

logger = logging.getLogger(__name__)


def get_redis(cfg: PolicyControlConfig | None = None) -> redis.Redis:
...
def read_group(
    ...
    *,
    ...
    for _stream, stream_messages in raw or []:
        for msg_id, fields in stream_messages:
            messages.append((msg_id, {key: try_json(value) for key, value in fields.items()}))
    return messages
