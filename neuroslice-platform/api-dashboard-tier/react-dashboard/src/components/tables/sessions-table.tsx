  ...
  return (
    <Card className="overflow-hidden">
      <div className="border-b border-white/5 px-5 py-4">
        <h3 className="text-lg font-semibold text-white">Network sessions</h3>
        <p className="text-sm text-mutedText">
          Operator view with the latest prediction and recommended action.
        </p>
      </div>
        ...
        <table className="min-w-full divide-y divide-white/5 text-sm">
          <thead className="bg-slate-950/45 text-left text-xs uppercase tracking-[0.24em] text-mutedText">
            <tr>
              ...
              <th className="px-5 py-4">Radio quality</th>
              ...
              <tr key={session.id} className="hover:bg-white/[0.03]">
                ...
                <td className="px-5 py-4 align-top">
                  {session.prediction ? (
                    ...
                    <span className="text-mutedText">No prediction</span>
                  )}
                </td>
                <td className="px-5 py-4 align-top">
                  {session.prediction ? (
                    ...
                    <span className="text-mutedText">No action</span>
                  )}
                </td>
                <td className="px-5 py-4 align-top">
